...
public class DoubleColumn extends Column {
	...
	public BigDecimal asBigDecimal() {
		...
		try {
			...
			throw new IllegalArgumentException(String.format("String[%s] 无法转换为Double类型 .", this.getRawData()));
		}
	}
	...
	public Boolean asBoolean() {
		throw new IllegalArgumentException("Double类型无法转为Bool .");
	}

	@Override
	public Date asDate() {
		throw new IllegalArgumentException("Double类型无法转为Date类型 .");
	}
	...
	@Override
	public byte[] asBytes() {
		throw new IllegalArgumentException("Double类型无法转为Bytes类型 .");
	}
	...
	private void validate(final String data) {
		...
		try {
			...
			throw new IllegalArgumentException(String.format("String[%s]无法转为Double类型 .", data));
		}
	}
