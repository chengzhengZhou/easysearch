...
public class DataCopier {
    ...
    public static <T extends DataSetMeta> T copy(T record) {
        if (record == null) {
            return null;
        }
        ...
        try {
            ...
            throw new DataCopyException("record copy failed.", e);
        }
    }

    public static <T extends DataSetMeta> List<T> copyList(List<T> list) {
            ...
            try {
                ...
                if (e instanceof ProtobufException) {
                    if ("Protocol message was too large.  May be malicious.  Use CodedInput.setSizeLimit() to increase the size limit.".equals(e.getMessage())) {
                        ...
                        throw new DataCopyException("record list copy failed.", e);
                    }
                } else {
                    throw new DataCopyException("record list copy failed.", e);
                }
    ...
    private static <T extends DataSetMeta> List<T> copyListInternal(List<T> list) throws Exception {
    ...
    public static Object deserialize(byte[] paramArrayOfByte, Class targetClass) throws Exception {
