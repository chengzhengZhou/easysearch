...
public class DateColumn extends Column {
	...
	public String asString() {
		try {
			...
			throw new IllegalArgumentException(String.format("Date[%s]类型不能转为String .", this.toString()));
		}
	}
	...
	@Override
	public byte[] asBytes() {
		throw new IllegalArgumentException("Date类型不能转为Bytes .");
	}

	@Override
	public Boolean asBoolean() {
		throw new IllegalArgumentException("Date类型不能转为Boolean .");
	}
	...
	public BigInteger asBigInteger() {
		throw new IllegalArgumentException("Date类型不能转为BigInteger .");
	}

	@Override
	public BigDecimal asBigDecimal() {
		throw new IllegalArgumentException("Date类型不能转为BigDecimal .");
	}
