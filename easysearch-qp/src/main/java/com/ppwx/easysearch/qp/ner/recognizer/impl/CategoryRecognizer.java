 ...
 * 
 */
public class CategoryRecognizer extends AbstractDictionaryBasedRecognizer {
    
    public CategoryRecognizer(EntityTypeNormalizer normalizer,
                             EntityIdentityMapper identityMapper) {
        super(EntityType.CATEGORY, normalizer, identityMapper);
    }
