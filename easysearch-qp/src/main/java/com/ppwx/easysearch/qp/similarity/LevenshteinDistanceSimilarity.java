...
public class LevenshteinDistanceSimilarity implements SequenceSimilarityScore<Double> {
    ...
    @Override
    public Double apply(CharSequence left, CharSequence right, Filter<Character> charFilter) {
        ...
        return NumberUtil.div(temp - distance, temp);
    }
     ...
     * @return 处理后的字符串
     */
    private static CharSequence removeSign(CharSequence str, Filter<Character> charFilter) {
