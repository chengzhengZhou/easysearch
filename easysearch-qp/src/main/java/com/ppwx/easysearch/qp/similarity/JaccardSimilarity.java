...
public class JaccardSimilarity implements WordSimilarityScore<Double>, SequenceSimilarityScore<Double> {
    ...
    private Double calculateJaccardSimilarity(CharSequence left, CharSequence right, Filter<Character> charFilter) {
        ...
        if (leftLength == 0 && rightLength == 0) {
            ...
            for(int i = 0; i < leftLength; ++i) {
                if (charFilter == null || !charFilter.accept(left.charAt(i))) {
            ...
            for(int i = 0; i < rightLength; ++i) {
                if (charFilter == null || !charFilter.accept(right.charAt(i))) {
